...
class Dish_info extends React.Component{
    render(){
            ...
            <div className="card mb-3 recipeCard">
                <div className="row no-gutters">
                    <div className="col-md-4">
                        <img src="..." className="card-img" alt={t("imgAlt")}>
                    ...
                    <div className="col-md-12">
                        <button type="button" class="btn btn-warning btn-lg btn-block">Back</button>
                    </div>
                </div>
            </div>
        );
...
export default withNamespaces()(Dish_info)
