        ...
        return(
            <div className="card mb-3 recipeCard">
                <div className="row no-gutters">
                    ...
                    <div className="col-md-12">
                        <button type="button" class="btn btn-warning btn-lg btn-block">{t("backBtn")}<svg class="bi bi-box-arrow-in-left" width="1.4rem" height="1.4rem" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
