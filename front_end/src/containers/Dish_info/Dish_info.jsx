                ...
                <div className="row no-gutters">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            <h5 className="card-title">{dishList[id].dish_name}</h5>
                            <p className="card-text">{dishList[id].dish_description}</p>
                            {dishList[id].ingredient_id.map(item => (  <p className="card-text"> {ingridientList[item-1].ingredient_name}</p>))}
                    ...
                    <div className="col-md-12">
                        <p>{dishList[id].recipe}</p>
                    </div>
                    <div className="col-md-12">
                      <NavLink className="btn btn-warning btn-lg btn-block" to='/'>{t("backBtn")}<svg class="bi bi-box-arrow-in-left" width="1.4rem" height="1.4rem" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
